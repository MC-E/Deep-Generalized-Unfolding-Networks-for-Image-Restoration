...
class Config(object):
    ...
    def __init__(self, config_yaml: str, config_override: List[Any] = []):
        ...
        self._C.TRAINING.TRAIN_DIR_noise = 'images_dir/train'
        self._C.TRAINING.VAL_DIR_noise = 'images_dir/val'
        self._C.TRAINING.TRAIN_DIR_blur = 'images_dir/train'
        self._C.TRAINING.VAL_DIR_blur = 'images_dir/val'
        self._C.TRAINING.TRAIN_DIR_rain = 'images_dir/train'
        self._C.TRAINING.VAL_DIR_rain = 'images_dir/val'
        self._C.TRAINING.SAVE_DIR = 'checkpoints'
        self._C.TRAINING.TRAIN_PS_noise = 64
        self._C.TRAINING.VAL_PS_noise = 64
        self._C.TRAINING.TRAIN_PS_blur = 64
        self._C.TRAINING.VAL_PS_blur = 64
        self._C.TRAINING.TRAIN_PS_rain = 64
        self._C.TRAINING.VAL_PS_rain = 64
