...
class DGUNet(nn.Module):
    def __init__(self, in_c=3, out_c=3, n_feat=80, scale_unetfeats=40, scale_orsnetfeats=32, num_cab=8, kernel_size=3,
    ...
    def forward(self, img):
        ...
        feat2,feat_fin2 = self.stage2_encoder(x2_cat, feat1, res1) # Features interaction within encoder
        res2 = self.stage2_decoder(feat_fin2,feat2)                # Features interaction within decoder
