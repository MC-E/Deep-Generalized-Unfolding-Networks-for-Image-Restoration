...
parser.add_argument('--src_dir', default='/userhome/dataset/mnt/d/SIDD_Medium_Srgb/Data', type=str, help='Directory for full resolution images')
parser.add_argument('--tar_dir', default='SIDD_DATA',type=str, help='Directory for image patches')
