...
#         ##-------------------------------------------
#         ## Compute Shallow Features
        phixsy_7 = self.phi_6(stage4_img) - img
        x7_img = stage4_img - self.r6*self.phit_6(phixsy_7)
        x7 = self.shallow_feat7(x7_img)
#         ## Concatenate SAM features of Stage 2 with shallow features of Stage 3
        x7_cat = self.concat67(torch.cat([x7, x5_samfeats], 1))
        stage7_img = self.tail(x7_cat)+ img

        return [stage7_img,stage4_img, stage3_img, stage2_img, stage1_img]#[stage5_img + img, stage4_img, stage3_img, stage2_img, stage1_img]
