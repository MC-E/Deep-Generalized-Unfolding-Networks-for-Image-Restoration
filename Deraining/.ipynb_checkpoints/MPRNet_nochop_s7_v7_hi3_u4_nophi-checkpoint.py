...
#         x1_img = img - self.r0*self.phit_0(phixsy_1)
        ...
        x2_samfeats, stage1_img = self.sam12(res1[-1], img)
...
#         x2_img = stage1_img - self.r1*self.phit_1(phixsy_2)
        x2 = self.shallow_feat2(stage1_img)
        ...
        ## Apply SAM
        x3_samfeats, stage2_img = self.sam23(res2[-1], stage1_img)
...
#         x3_img = img * self.r2 + (1 - self.r2) * stage2_img
        x3 = self.shallow_feat3(stage2_img)
        ...
        ## Apply SAM
        x4_samfeats, stage3_img = self.sam34(res3[-1], stage2_img)
...
#         x4_img = stage3_img - self.r3*self.phit_3(phixsy_4)
        x4 = self.shallow_feat4(stage3_img)
        ## Concatenate SAM features of Stage 1 with shallow features of Stage 2
        ...
        ## Apply SAM
        x5_samfeats, stage4_img = self.sam45(res4[-1], stage3_img)
...
#         x5_img = stage4_img - self.r4*self.phit_4(phixsy_5)
        x5 = self.shallow_feat5(stage4_img)
        ## Concatenate SAM features of Stage 1 with shallow features of Stage 2
        ...
        ## Apply SAM
        x6_samfeats, stage5_img = self.sam56(res5[-1], stage4_img)
...
#         x6_img = stage5_img - self.r5*self.phit_5(phixsy_6)
        x6 = self.shallow_feat6(stage5_img)
        ## Concatenate SAM features of Stage 1 with shallow features of Stage 2
        ...
        ## Apply SAM
        x7_samfeats, stage6_img = self.sam67(res6[-1], stage5_img)
...
#         x7_img = stage6_img - self.r6*self.phit_6(phixsy_7)
        x7 = self.shallow_feat7(stage6_img)
