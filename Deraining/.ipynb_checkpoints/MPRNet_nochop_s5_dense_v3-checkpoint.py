...
class MPRNet(nn.Module):
    ...
    def forward(self, img):
        ...
        x2_samfeats, stage1_img = self.sam12(res1[0], x1_img)
        ...
        ##-------------------------------------------
        ## Compute Shallow Features
        x4_img = img * self.r3 + (1 - self.r3) * stage3_img
        ...
        ## Apply SAM
        x5_samfeats, stage4_img = self.sam45(res4[0], x4_img)

        ##-------------------------------------------
        ##-------------- Stage 5---------------------
        ##-------------------------------------------
        ## Compute Shallow Features
        x5_img = img * self.r4 + (1 - self.r4) * stage4_img
